...
export function customEntityTransform(entity: Object, text: string): string {
  ...
  if (entity.type === 'IMAGE') {
    return `<img src="${entity.data.src}" style="float:${entity.data
      .alignment || 'none'};height: ${entity.data.height};width: ${entity.data
      .width}"/>`
  }
  if (entity.type === 'EMBEDDED_LINK') {
    return `<div class="responsive-embed"><iframe width="${entity.data
      .width}" height="${entity.data.height}" src="${entity.data
